...
@mysql_select_db($database) or die("Unable to select database");
   ...
   if($missions === "open")
         $query = "SELECT * FROM `MISSIONS` WHERE `STATUS` !=  'Done'  AND `WORKERID` = '".$workerid."' ORDER BY `STATUS` DESC ";
   else if($missions === "close")
         $query = "SELECT * FROM `MISSIONS` WHERE `STATUS` =  'Done' AND `WORKERID` = '".$workerid."' ORDER BY `STATUS` DESC "; 
   else
   	  $query = "SELECT * FROM `MISSIONS` WHERE `WORKERID` = '".$workerid."' ORDER BY `STATUS` DESC "; 
